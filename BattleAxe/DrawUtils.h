...
public:
	...
	static float getTextWidth(std::string* textStr, float textSize = 1, Fonts font = Fonts::RUNE);
	...
	static void drawText(vec2_t pos, std::string* text, MC_Color color, float textSize = 1, float alpha = 1, Fonts font = Fonts::RUNE);
