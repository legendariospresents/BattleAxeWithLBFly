...
void ScriptManager::prepareBattleFunctions(JsValueRef global, ContextObjects* obj) {
	...
	JsValueRef battleObject;
	chakra.JsCreateObject_(&battleObject);

	chakra.addPropertyToObj(global, L"Battle Axe", battleObject);

	chakra.defineFunction(battleObject, L"getCommandManager", theBattleFunctions::getCommandManager, obj);
	chakra.defineFunction(battleObject, L"getModuleManager", theBattleFunctions::getModuleManager, obj);
	chakra.defineFunction(battleObject, L"getDrawUtils", theBattleFunctions::getDrawUtils, obj);
}
...
void ScriptManager::prepareContext(JsContextRef* ctx, ContextObjects* obj) {
	...
	prepareBattleFunctions(globalObject, obj);
